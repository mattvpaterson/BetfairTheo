...
class Data:
    ...
    def match(self, files_loc):
        ...
        self.base['BSP'] = self.base.apply(lambda x: x['match'][5], axis=1)
    ...
    def race_finder(date,horse_name,files_loc):
        ...
        try:
            ...
            return [newframe['PPWAP'].values[0],newframe['PPMAX'].values[0],newframe['PPMIN'].values[0],newframe['PPTRADEDVOL'].values[0],newframe['WIN_LOSE'].values[0],newframe['BSP'].values[0]]
        except:
